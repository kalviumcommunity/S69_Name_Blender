...
//             ? {
//                 ...msg,
//                 reactions: [...(msg.reactions || []).filter(r => r.userId !== userId), { emoji, userId }],
//               }
//             : msg
//         )
//       );
...
//     setMenuOpen(null);
//     menuTimeoutRef.current = setTimeout(() => setReactionMenuOpen(null), 3000);
//   };
...
//                                     data-tooltip-id={`reaction-tooltip-${msg._id}-${emoji}`}
//                                     data-tooltip-content={reactors.map(r => r.userId).join(", ")}
//                                   >
...
//                               data-tooltip-id={`react-tooltip-${msg._id}`}
//                               data-tooltip-content="React to Message"
//                             >
//                               <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
//                               React
//                             </button>
//                             <Tooltip id={`react-tooltip-${msg._id}`} />
//                           </div>
//                           <div className={`absolute z-10 mt-2 w-32 rounded-lg shadow-lg ${msg.senderId === user.name ? "right-0" : "left-0"} ${darkMode ? "bg-gray-800 text-white" : "bg-white text-gray-900"} border ${darkMode ? "border-gray-700" : "border-gray-300"} transition-opacity duration-200 ${reactionMenuOpen === msg._id ? "opacity-100 visible" : "opacity-0 invisible"}`}>
//                             {reactionOptions.map(emoji => (
//                               <button
//                                 key={emoji}
//                                 onClick={() => handleAddReaction(msg._id, emoji)}
//                                 className={`w-full text-left px-3 py-1.5 text-sm hover:${darkMode ? "bg-gray-700" : "bg-gray-200"} flex items-center gap-2`}
//                               >
//                                 {emoji}
//                               </button>
//                             ))}
//                             {msg.reactions?.some(r => r.userId === user.name) && (
//                               <button
